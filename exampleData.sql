...
INSERT INTO api_aoi(name, x_min, x_max, y_min, y_max, creation_date, is_deleted,geographical_zone_id,owner_id) 
VALUES('El vall', 1.847184, 1.856271, 42.103886, 42.104607,  NOW(), false, 1,1),
('Casserres', 1.829846, 1.852055, 42.004503, 42.015616, NOW(), false, 2,2), 
('Passeig de la pau', 1.844118, 1.846347, 42.097506, 42.101407, NOW(), false, 1,1);
...
INSERT INTO api_surveydata(name, tree_specie_id, crown_diameter_id, canopy_status_id, comment, owner_id, aoi_id, gz_id, longitude, latitude, compass, creation_date, update_date, is_deleted)
...
INSERT INTO api_photo(survey_data_id, longitude, latitude, compass, url) VALUES
(2, 1.849544, 42.104026, 35.378, 'obs/1.png'),
(3, 1.849544, 42.104026, 35.378, 'obs/2.png'),
(1, 1.849544, 42.104026, 35.378, 'obs/3.png'),
(1, 1.849544, 42.104026, 25.378, 'obs/4.png'),
(3, 1.849544, 42.104026, 25.378, 'obs/5.png');
